...
@pytest.mark.parametrize(
    ("text", "hand"),
    [
        ("32T3K 765", Hand(cards="32T3K", type_=HandType.ONE_PAIR, bid=765, strength_order=JOKER_STRENGTH_ORDER)),
        ("T55J5 684", Hand(cards="T55J5", type_=HandType.FOUR_OF_A_KIND, bid=684, strength_order=JOKER_STRENGTH_ORDER)),
        ("KK677 28", Hand(cards="KK677", type_=HandType.TWO_PAIR, bid=28, strength_order=JOKER_STRENGTH_ORDER)),
        ("KTJJT 220", Hand(cards="KTJJT", type_=HandType.FOUR_OF_A_KIND, bid=220, strength_order=JOKER_STRENGTH_ORDER)),
        ("QQQJA 483", Hand(cards="QQQJA", type_=HandType.FOUR_OF_A_KIND, bid=483, strength_order=JOKER_STRENGTH_ORDER)),
        ("JJJJJ 99", Hand(cards="JJJJJ", type_=HandType.FIVE_OF_A_KIND, bid=99, strength_order=JOKER_STRENGTH_ORDER)),
        ("JJAJJ 14", Hand(cards="JJAJJ", type_=HandType.FIVE_OF_A_KIND, bid=14, strength_order=JOKER_STRENGTH_ORDER)),
        ("KKJJJ 28", Hand(cards="KKJJJ", type_=HandType.FIVE_OF_A_KIND, bid=28, strength_order=JOKER_STRENGTH_ORDER)),
        ("JJ558 33", Hand(cards="JJ558", type_=HandType.FOUR_OF_A_KIND, bid=33, strength_order=JOKER_STRENGTH_ORDER)),
    ],
)
